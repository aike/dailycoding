...
function fillrect_init(g, x0, y0, w) {
  ...
  col1 = color(h, 40, 95, 20);
  col2 = color((h + 60) % 360, 40, 95, 20);
  ...
  for (let y = 0; y < csize; y++) {
    for (let x = 0; x < csize; x++) {
      let s =
          ...
          cget(xy, x - 1, y + 1) + cget(xy, x, y + 1) + cget(xy, x + 1, y + 1)
      let num_breed1 = s % 10;
      let num_breed2 = floor(s / 10);
      let v;
      if ((num_breed1 >= 2 && num_breed1 <= 3) && (num_breed1 > num_breed2)) {
        v = breed1;
      } else if ((num_breed2 >= 2 && num_breed2 <= 3) && (num_breed2 > num_breed1)) {
        v = breed2;
      } else {
        v = 0;
      }
