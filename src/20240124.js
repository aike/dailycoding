...
class Boid {
  ...
  show() {
    ...
    //g.noStroke();
    //g.ellipse(this.position.x, this.position.y, this.sz, this.sz);    
    if (this.prev) {
      g.stroke(this.hu, this.st, this.br, 10);
      g.strokeWeight(this.sz);
      g.line(this.position.x, this.position.y, this.prev.position.x, this.prev.position.y)      
    }
  }
