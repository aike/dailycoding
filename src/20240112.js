...
class Particle {
  ...
  reset(sz) {
    ...
    this.sz = (1 + pow(2, random(3))) * sz;
    this.interval = 5 + int(this.sz) * 3;
  }
  ...
  show(ox, oy, w, gn) {
    ...
    this.g.fill(hu, 100, 100, 100);
    this.g.noStroke();
    //this.g.ellipse(this.pos.x % w, this.pos.y % w, sz, sz);
    
    
    let ch = String.fromCharCode(0x3041 + floor(random(0x3093 - 0x3041)));
    this.g.textSize(sz);
    this.g.textAlign(CENTER);
    this.g.text(ch, this.pos.x % w, this.pos.y % w);
