...
function fillrect_init(g, x0, y0, w) {
  ...
  //col0 = color(h, 3, 100, 1);
  //col1 = color(h, 20, 100, 20);
  //col2 = color(h, 30, 80, 20);
  //col3 = color(h, 40, 60, 20);
  col0 = color(0, 0, 100, 1);
  col1 = color(0, 60, 90, 20);
  col2 = color(240, 50, 90, 20);
  col3 = color(0, 0, 100, 20);  
  ...
  for (let y = 0; y < csize; y++) {
    for (let x = 0; x < csize; x++) {
      let s =
          ...
          cget(xy, x - 1, y + 1) + cget(xy, x, y + 1) + cget(xy, x + 1, y + 1)
      let num_breed1 = s & 0xF;
      let num_breed2 = (s & 0xF0) / 0x10;
      let num_breed3 = (s & 0xF00) / 0x100;
      let v;
      if        ((num_breed1 >= 2 && num_breed1 <= 3) && (num_breed1 > num_breed2) && (num_breed1 > num_breed3)) {
        v = breed1;
      } else if ((num_breed2 >= 2 && num_breed2 <= 3) && (num_breed2 > num_breed1) && (num_breed2 > num_breed3)) {
        v = breed2;
      } else if ((num_breed3 >= 2 && num_breed3 <= 3) && (num_breed3 > num_breed1) && (num_breed3 > num_breed2)) {
        v = breed3;
      } else {
        v = 0;
      }
