const imgs = [
  ...
  ["20240109", "断続的なパーティクル"], 
  ["20240110", "半透明のパーティクル"], 
  ["20240111", "断続的でカラフルなパーティクル"], 
  ["20240112", "ひらがなのパーティクル"], 
  ["20240113", "漢字のパーティクル"], 
  ["20240114", "星形のパーティクル"], 
  ["20240115", "雪形のパーティクル"], 
  ["20240116", "雪形のパーティクルにブラーエフェクト"], 
  ["20240117", "カラフルなパーティクルにブラーエフェクト"], 
  ["20240118", "弾幕パーティクル"], 
  ["20240119", "垂直弾幕パーティクル"], 
  ["20240120", "扇型弾幕パーティクル"], 
  ["20240121", "反射なし弾幕パーティクル"], 
  ["20240122", "ホーミング弾幕パーティクル"], 
  ["20240123", "Boidsパーティクル"], 
  ["20240124", "Boids間を結ぶ直線"], 
  ["20240125", "パーティクル間の距離でサイズが変わるBoids"], 
  ["20240126", "距離でサイズが変わる矩形と円のBoids"], 
  ["20240127", "カラフルで拡大する弾幕パーティクル"], 
  ["20240128", "二色の流体パーティクル"], 
  ["20240129", "三色の流体パーティクル"], 
  ["20240130", "距離でサイズを変える不透明な流体パーティクル"], 
  ["20240131", "Pong Wars"], 
  ["20240201", "反転するたびに色が変化するPong Wars"], 
  ["20240202", "感染セルと隣接すると感染して色が変わるライフゲーム"], 
  ["20240203", "セルの大きさが成長するライフゲーム"], 
  ["20240204", "星形の成長するライフゲーム"], 
];
